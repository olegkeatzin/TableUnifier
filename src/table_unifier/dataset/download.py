...
# ------------------------------------------------------------------ #
#  Hold-out датасеты для cross-domain тестирования
# ------------------------------------------------------------------ #
# Эти датасеты НЕ участвуют в обучении (round-robin).
# Модель оценивается на них «с нуля» — проверка обобщающей способности.
# Выбраны из разных доменов для покрытия разнообразия:

HOLDOUT_DATASETS: list[str] = [
    "electronics",   # единственный в домене electronics
    "restaurants3",  # самый большой (38K строк, 24 столбца)
    "books2",        # много столбцов (16+16)
    "anime",         # единственный в домене anime
    "citations",     # единственный в домене bibliography
]
